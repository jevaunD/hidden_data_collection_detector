...
> *Because your data deserves a seat at the negotiation table.*

---

## Why This Exists

It started with a post by [Ryan Montgomery](<PASTE LINK HERE>) about the dangers of autofill — and honestly, it lit a fire. The realization hit: so much could be happening in the background, silently, without us ever knowing. Data being read, fields being tracked, inputs being harvested — all while we're just trying to fill out a form.
...
<!-- Suggested format: -->
<!-- [![Demo Video](./screenshots/video-thumbnail.png)](PASTE_VIDEO_LINK_HERE) -->
